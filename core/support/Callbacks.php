...
class Callbacks
{
    ...
    /**
     * Create an instance of Callbacks or return the already created instance.
     *
     * @return instance
     */
    ...
    */
    ...
    /**
     * Fire a callback. Returns a new instance of CallbackReturn.
     *
     * @param hook Hook string in Class.method format.
     * @param position Position in the method the callback is run, e.g. 'return'.
    ...
    // get our Loader.  (Loading in construct creates a loop/php-crash).
        if (empty($this->load)) {
