...
# echo "Change Admin Password with /var/www/observer/tools/cli/ob passwd <username>"
echo "Check for and apply updates /var/www/observer/tools/cli/ob updates run" 
echo ""
