...
class OBUpdate20210310 extends Update
{
    ...
    public function run()
    {
        ...
        if (!$players) {
            return true;
        } // no players, no timeslots.
        $timezones = [];
        foreach ($players as $player) {
            $timezones[$player['id']] = $player['timezone'];
        }
        ...
        foreach ($timeslots as $timeslot) {
            ...
            if (!$timezones[$timeslot['player_id']]) {
                continue;
